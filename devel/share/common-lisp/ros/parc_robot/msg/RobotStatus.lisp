...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name parc_robot-msg:<RobotStatus> is deprecated: use parc_robot-msg:RobotStatus instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader parc_robot-msg:status-val is deprecated.  Use parc_robot-msg:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RobotStatus>)))
  ...
  (cl:format cl:nil "# The status of the robot => \"started\" or \"finished\"~%string status~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RobotStatus)))
  "Returns full string definition for message of type 'RobotStatus"
  (cl:format cl:nil "# The status of the robot => \"started\" or \"finished\"~%string status~%~%~%"))
